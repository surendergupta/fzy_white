      ...
      <div className="contactpageConatiner">
        ...
        <div className="contactTop">
          <div className="contactTopContent">
            ...
            <p>
              The easiest way to get in touch is to fill out the form below.
            </p>
          </div>
        </div>
        <section className="userContact">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to FZY TOKEN.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to FZY TOKEN, accessible from{" "}
                <a
                  href="https://fizzyfycoin.com"
                  rel="noreferrer"
                  target="_blank"
                >
                  https://fizzyfycoin.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: support@fizzyfycoin.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://fizzyfycoin.com/contact"
                  rel="noreferrer"
                  target="_blank"
                >
                  https://fizzyfycoin.com/contact
                </a>
              </p>
            </li>
          </ul>
